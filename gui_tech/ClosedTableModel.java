...
public class ClosedTableModel extends AbstractTableModel{

    private List<Ticket> data = new ArrayList<>();
    private String[] col = {"Ticket","Client ID","Description","Priority","Opened","Closed"};
        ...
        switch(coluna){
            ...
            case 4: 
    		  ...
    		  String formatted = format.format(date);
                return formatted;
            case 5: 
      		  Date dateC = new Date(data.get(linha).getClosed() * 1000L);
    		  DateFormat formatC = new SimpleDateFormat("HH:mm - dd/MM/yy");
    		  String formattedC = formatC.format(dateC);
                return formattedC;
        }
